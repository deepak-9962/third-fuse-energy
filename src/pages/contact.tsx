              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  {company.secondAddress && (
                    <div className="flex gap-4">
                      <a
                        href={`https://www.google.com/maps/search/${encodeURIComponent(`${company.secondAddress.street}, ${company.secondAddress.area || ''}, ${company.secondAddress.city} ${company.secondAddress.zip}`)}`}
                        target="_blank"
                      ...
                      <div>
                        ...
                        <address className="not-italic text-text-light mt-1">
                          ...
                          {company.secondAddress.city} – {company.secondAddress.zip}
                        </address>
                      </div>
                    </div>
                  )}
